...
namespace Obi
{
    ...
    public class ObiSoftbody : ObiActor, IShapeMatchingConstraintsUser
    {
        ...
        [SerializeField] protected bool m_DirectionalCollisions = false;
        ...
        /// <summary>  
        /// Whether particles in this actor use sparse distance field values to solve locking/penetration issues during intercollisions.
        /// </summary>
        public bool directionalCollisions
        {
            get { return m_DirectionalCollisions; }
            set { if (value != m_DirectionalCollisions) { m_DirectionalCollisions = value; SetDirectionalCollisions(m_DirectionalCollisions); } }
        }
        ...
        private void SetupRuntimeConstraints()
        {
            ...
            SetDirectionalCollisions(m_DirectionalCollisions);
