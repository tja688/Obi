...
namespace Obi
{
    ...
    public class ObiSoftbodySurfaceBlueprintEditor : ObiMeshBasedActorBlueprintEditor
    {
        ...
        SerializedProperty planeProjection;
        ...
        protected override void DrawBlueprintProperties()
        {
            ...
            EditorGUILayout.PropertyField(planeProjection);
        ...
        public override void OnEnable()
        {
            ...
            planeProjection = serializedObject.FindProperty("planeProjection");
            ...
            renderModes.Add(new ObiBlueprintRenderModeCollisionDirection(this));
