 ...
 */
    ...
    public class ObiSoftbodyEditor : Editor
    {
        ...
        SerializedProperty directionalCollisions;
        ...
        public void OnEnable()
        {
            ...
            directionalCollisions = serializedObject.FindProperty("m_DirectionalCollisions");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(directionalCollisions, new GUIContent("Directional collisions"));
