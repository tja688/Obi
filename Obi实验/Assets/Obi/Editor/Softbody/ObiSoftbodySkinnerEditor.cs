            ...
            if (skinner.customSkinMap != null)
            {
                ...
                if (bindFoldout)
                {
                    if (skinner.customSkinMap != null)
                    {
                        ...
                        {
                            var path = EditorUtility.SaveFilePanel("Save texture as PNG", // TODO: use EXR for better precision in 2023 and up (older versions LoadImage doesnt work with EXR).
                                                                    "",
                                                                    "property.png",
                                                                    "png");
                            if (path.Length > 0)
